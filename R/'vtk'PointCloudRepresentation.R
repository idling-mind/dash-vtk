...
#' @export
'vtk'PointCloudRepresentation <- function(id=NULL, colorDataRange=NULL, colorMapPreset=NULL, cubeAxesStyle=NULL, property=NULL, rgb=NULL, rgba=NULL, scalarBarStyle=NULL, scalarBarTitle=NULL, scalars=NULL, showCubeAxes=NULL, showScalarBar=NULL, xyz=NULL) {
