...
function __init__()
    ...
    external_url = "https://unpkg.com/dash_vtk@0.0.10/dash_vtk/dash_vtk.min.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_vtk@0.0.10/dash_vtk/dash_vtk.min.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_vtk@0.0.10/dash_vtk/async-ReactVTK.js",
    dynamic = nothing,
    async = :true,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_vtk@0.0.10/dash_vtk/async-ReactVTK.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
