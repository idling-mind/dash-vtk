...
export 'vtk'_volumedatarepresentation

"""
    'vtk'_volumedatarepresentation(;kwargs...)
...
"""
function 'vtk'_volumedatarepresentation(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("'vtk'_volumedatarepresentation", "VolumeDataRepresentation", "dash_vtk", available_props, wild_props; kwargs...)
end
