...
export 'vtk'_slicerepresentation

"""
    'vtk'_slicerepresentation(;kwargs...)
    'vtk'_slicerepresentation(children::Any;kwargs...)
    'vtk'_slicerepresentation(children_maker::Function;kwargs...)
...
"""
function 'vtk'_slicerepresentation(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("'vtk'_slicerepresentation", "SliceRepresentation", "dash_vtk", available_props, wild_props; kwargs...)
end

'vtk'_slicerepresentation(children::Any; kwargs...) = 'vtk'_slicerepresentation(;kwargs..., children = children)
'vtk'_slicerepresentation(children_maker::Function; kwargs...) = 'vtk'_slicerepresentation(children_maker(); kwargs...)
