...
export 'vtk'_glyphrepresentation

"""
    'vtk'_glyphrepresentation(;kwargs...)
    'vtk'_glyphrepresentation(children::Any;kwargs...)
    'vtk'_glyphrepresentation(children_maker::Function;kwargs...)
...
"""
function 'vtk'_glyphrepresentation(; kwargs...)
        available_props = Symbol[:children, :id, :actor, :colorDataRange, :colorMapPreset, :mapper, :property]
        wild_props = Symbol[]
        return Component("'vtk'_glyphrepresentation", "GlyphRepresentation", "dash_vtk", available_props, wild_props; kwargs...)
end

'vtk'_glyphrepresentation(children::Any; kwargs...) = 'vtk'_glyphrepresentation(;kwargs..., children = children)
'vtk'_glyphrepresentation(children_maker::Function; kwargs...) = 'vtk'_glyphrepresentation(children_maker(); kwargs...)
