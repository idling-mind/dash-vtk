...
export 'vtk'_polydata

"""
    'vtk'_polydata(;kwargs...)
    'vtk'_polydata(children::Any;kwargs...)
    'vtk'_polydata(children_maker::Function;kwargs...)
...
"""
function 'vtk'_polydata(; kwargs...)
        available_props = Symbol[:children, :id, :connectivity, :lines, :points, :polys, :port, :strips, :verts]
        wild_props = Symbol[]
        return Component("'vtk'_polydata", "PolyData", "dash_vtk", available_props, wild_props; kwargs...)
end

'vtk'_polydata(children::Any; kwargs...) = 'vtk'_polydata(;kwargs..., children = children)
'vtk'_polydata(children_maker::Function; kwargs...) = 'vtk'_polydata(children_maker(); kwargs...)
