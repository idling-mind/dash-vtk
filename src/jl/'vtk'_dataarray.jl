...
export 'vtk'_dataarray

"""
    'vtk'_dataarray(;kwargs...)
...
"""
function 'vtk'_dataarray(; kwargs...)
        available_props = Symbol[:id, :name, :numberOfComponents, :registration, :type, :values]
        wild_props = Symbol[]
        return Component("'vtk'_dataarray", "DataArray", "dash_vtk", available_props, wild_props; kwargs...)
end
